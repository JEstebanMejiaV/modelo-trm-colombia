...
_TERM_LABELS: dict[str, str] = {
    "const": "Constante",
    "D.ln_terminos_intercambio.L0": r"\(\Delta\ln\) términos de intercambio, mes actual",
    "D.ln_remesas_12m.L1": r"\(\Delta\ln\) remesas 12 meses, rezago 1",
    "D.diferencial_tasas_pp.L1": r"\(\Delta\) diferencial de tasas, rezago 1",
    "D.deficit_fiscal_12m_pct_pib.L1": r"\(\Delta\) déficit fiscal 12 meses/PIB, rezago 1",
    "D.ln_dolar_amplio.L0": r"\(\Delta\ln\) dólar amplio, mes actual",
    "D.ln_vix.L0": r"\(\Delta\ln\) VIX, mes actual",
    "D.embig_colombia_pp.L0": r"\(\Delta\) EMBIG Colombia, en puntos porcentuales, mes actual",
    "D.ln_reservas_netas_sin_flar.L1": r"\(\Delta\ln\) reservas netas sin FLAR, rezago 1",
    "D.asinh_balanza_comercial.L1": r"\(\Delta\,\mathrm{asinh}\) balanza comercial cambiaria, rezago 1",
    "D.asinh_flujos_capital.L1": r"\(\Delta\,\mathrm{asinh}\) movimientos netos de capital, rezago 1",
    "D.diferencial_bei_5y_pp.L1": r"\(\Delta\) diferencial de compensación inflacionaria 5 años, rezago 1",
    "factor_monedas_regionales_4.L0": "Factor regional BRL, CLP, MXN y PEN, mes actual",
    "factor_monedas_regionales_3.L1": "Factor regional BRL, CLP y MXN, rezago 1",
    "dummy_pandemia_2020": "Indicador de pandemia, marzo–mayo de 2020",
}
